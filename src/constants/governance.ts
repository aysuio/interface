...
export const COMMON_CONTRACT_NAMES: Record<number, { [address: string]: string }> = {
  [SupportedChainId.ETHPOW]: {
    [UNI_ADDRESS[SupportedChainId.ETHPOW]]: 'UNI',
    [TIMELOCK_ADDRESS[SupportedChainId.ETHPOW]]: 'Timelock',
    [GOVERNANCE_ALPHA_V0_ADDRESSES[SupportedChainId.ETHPOW]]: 'Governance (V0)',
    [GOVERNANCE_ALPHA_V1_ADDRESSES[SupportedChainId.ETHPOW]]: 'Governance (V1)',
    [GOVERNANCE_BRAVO_ADDRESSES[SupportedChainId.ETHPOW]]: 'Governance',

...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [SupportedChainId.ETHPOW]: [
    ...WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.ETHPOW],
    DAI,
    USDC_MAINNET,
    USDT,
    WBTC,
...
export const CUSTOM_BASES: { [chainId: number]: { [tokenAddress: string]: Token[] } } = {
  [SupportedChainId.ETHPOW]: {
    [AMPL.address]: [DAI, WRAPPED_NATIVE_CURRENCY[SupportedChainId.ETHPOW] as Token],
  },
}
...
export const COMMON_BASES: ChainCurrencyList = {
  [SupportedChainId.ETHPOW]: [
    nativeOnChain(SupportedChainId.ETHPOW),
    DAI,
    USDC_MAINNET,
    USDT,
    WBTC,
    WRAPPED_NATIVE_CURRENCY[SupportedChainId.ETHPOW] as Token,
  ],
  ...
  [SupportedChainId.ETHFAIR]: [
    nativeOnChain(SupportedChainId.ETHFAIR),
    WRAPPED_NATIVE_CURRENCY[SupportedChainId.ETHFAIR] as Token,
  ],
...
export const PINNED_PAIRS: { readonly [chainId: number]: [Token, Token][] } = {
  [SupportedChainId.ETHPOW]: [
    [
      new Token(SupportedChainId.ETHPOW, '0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643', 8, 'cDAI', 'Compound Dai'),
      new Token(
        SupportedChainId.ETHPOW,
